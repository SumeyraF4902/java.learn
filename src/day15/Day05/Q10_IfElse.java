...
public class Q10_IfElse {
    /*
        ...
        1'den 30'a kadar olan sayıları ancak 3'ün katı olan sayılar için yazdıran bir yöntem yazın,
        Sayı yerine Taş yazdırın ve 5'in katı olan sayılar için sayı yerine Yıldız yazdırın.
        Hem 3'ün hem de 5'in katı olan sayılar için, sayı yerine RockStar'ı yazdırın.
        ORNEK:
            INPUT     : 1 2 3 4 ..... 30
