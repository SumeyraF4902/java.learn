...
public class C03_LocalDateTime {
    public static void main(String[] args) {
        ...
        LocalDateTime ldt1=LocalDateTime.of(2018, Month.MAY,9,20,30);
        ...
        System.out.println("trhZmn.plusWeeks(3).minusDays(5).plusHours(13).minusMinutes(71) = " + trhZmn.plusWeeks(3).minusDays(5).plusHours(13).minusMinutes(71));
    }
}
