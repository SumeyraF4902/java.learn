...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        DateTimeFormatter dtf= DateTimeFormatter.ofPattern("dd :) /MMMM:) /YYYY");// gün ay yıl tanımlandı
        System.out.println("dtf.format(ldt) = " + dtf.format(ldt));//25/ Ekim/2022
        DateTimeFormatter dtf1= DateTimeFormatter.ofPattern("hh:mm:ss a"); //saat dakika saniye am-pm ilk harflerii yazılır format atandı
        System.out.println("dtf1 = " + dtf1.format(ldt));//11:24:17 ÖS öğleden sonra
        /*
            format->
            GUN
