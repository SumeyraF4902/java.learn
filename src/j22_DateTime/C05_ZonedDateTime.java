...
public class C05_ZonedDateTime {
    public static void main(String[] args) {
        ...
        LocalDate trhZone=LocalDate.now(ZoneId.of("America/New_York"));//America/New_York localinin anlık tarih bilgisi tanımlandı.
        LocalDate trhZone1=LocalDate.now(ZoneId.of("Japan"));//japan localinin anlık tarih bilgisi tanımlandı
