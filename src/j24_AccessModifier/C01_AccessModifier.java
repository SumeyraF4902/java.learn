...
public class C01_AccessModifier {
    ...
    /*
         ...
         Diğer class'lardan "private" class memler'lari kullanamaz. PRİVATE CLASS I KORUR
             ...
             3) Diğer package'lerden default class memberlara erişilemez.
              "default" ile "package private" es anlamlidir. DEFAULT PACKAGE Cİ KORUR APARTMAN İLİŞKİSİ
             ...
             için : a)Child class erişebilir. 	b)Child class degil ise erişilemez. AKRABA İLİŞKİSİ
    ...
    public C01_AccessModifier() {//private p siz const. ancak kendi clasından erişilebilir
        System.out.println( "agama private cons selam" );
    }

    public C01_AccessModifier(int privateYas, int defaultYas) {//public 2 parametreli cons.
