...
public class C01_HashSet {
    ...
    public static void main(String[] args) {
        ...
        HashSet<String> hs1=new HashSet<>(Arrays.asList("Ercan","Yakup","Adem","Rukiye","Nur"));// Eleman ataması yapılan  bir hashset
        //Set print etme...
        ...
        System.out.println("hs1="+hs1);//[Ercan, Adem, Kevser, Nur, Yakup, Rukiye] listenin içinde olanı birdaha eklemiyor.
        ...
        System.out.println("hs1.size() = " + hs1.size());// 7 uzunluğu

        System.out.println("hs1.isEmpty() = " + hs1.isEmpty());// false // boş mu
        hs1.clear();// tamamını silme
        System.out.println("hs1.isEmpty() = " + hs1.isEmpty());// true //boş mu

        System.out.println("hs1.size() = " + hs1.size());//0
        System.out.println("hs1 = " + hs1);// []

        System.out.println("hs2.contains(\"Basarı\") = " + hs2.contains("Basarı"));// true// içinde var mı

        System.out.println("hs2.contains(\"javaNAZZZ\") = " + hs2.contains("javaNAZZZ"));// false
        System.out.println("hs2.hashCode() = " + hs2.hashCode());//1769718834 // hashcodu
