...
public class C01_Queue {
    public static void main(String[] args) {
       ...
       */
        ...
        //elemen ilk elemanı verir eğer liste boş ise ilk eleman yoksa exception verir. exception olunca kendinden sonraki codelar çalışmaz
        //peek() ->ilk elemanı verir eğer liste boş ise ilk eleman yoksa null verir.
        q1.clear();//queue coll. elemanları silindi.
        System.out.println("q1 = " + q1);//[]
        System.out.println("q1.size() = " + q1.size());//0
        System.out.println("q1.poll() = " + q1.poll());//null
      //  System.out.println("q1.remove() = " + q1.remove());//NoSuchElementException5 hata verdiği zaman kendinden sonra
        //gelen code lar çalışmaz
