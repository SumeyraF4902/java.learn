...
public class Runner {
    public static void main(String[] args) {
        ...
        Aylar ay=Aylar.MART;// Aylar enumundan ay field value MART olarak atanıp tanımlandı.
        System.out.println(ay);
        System.out.println("ay.name() = " + ay.name());
        System.out.println("ay.ordinal() = " + ay.ordinal());// ordinal kacıncı sırada oldugunu yani indexi verir.
