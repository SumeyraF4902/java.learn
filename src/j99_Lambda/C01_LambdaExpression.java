...
public class C01_LambdaExpression {
	 ...
	 */
        List<Integer> sayi= new ArrayList<>(Arrays.asList(24,38,49,33,7,3,42,66,75,45,46,55,35,25,67,16));//24 38 49 33 7 3 42 66 75 45 46 55 35 25 67 16
    ...
    //TASK--> //Task : "Structured Programming" Amele code  kullanarak list elemanlarını aynı satirda aralarında bosluk olacak sekilde print ediniz.
